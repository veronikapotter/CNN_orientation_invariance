'''
This script runs Experiment 2 as defined in the accompanying manuscipt. 
'''
# to run: python3 run_exp_1.py ds_lo sensor1 sensor2 aug_1 aug_2 exp_name datasets
...
second_training_aug = argv[5]
experiment_num = argv[6]
datasets = list(argv[7:])
datasets = [int(x) for x in datasets]

print("ds_lo:", ds_lo)
print("sensors:", sensors)
print("training_aug:", first_training_aug, second_training_aug)
...
acc, f1s, conf = exp_2_train_and_test(
    training_accel_sets, 
    training_label_sets, 
    testing_accel_sets, 
    testing_label_sets,  
