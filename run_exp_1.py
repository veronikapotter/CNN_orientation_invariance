'''
This script runs Experiment 1 as defined in the accompanying manuscipt. 
'''
# to run: python3 run_exp_1.py ds_lo sensor1 aug_1 exp_name datasets
...
# output activity breakdown by dataset
for ds in datasets:
    print("\n***** breakdown:", ds)
    u, c = np.unique(clean_label[ds], return_counts=True)
    print(np.asarray((u, c)).T)

# set up file structure for all experiment outputs 
